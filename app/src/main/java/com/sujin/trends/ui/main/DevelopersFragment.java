...
public class DevelopersFragment extends Fragment {
    ...
    private RecyclerView.Adapter developersListAdapter;
    private RecyclerView.LayoutManager layoutManager;
    List<Developer> developers;


    public DevelopersFragment(List<Developer> developers)
    {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        developersListAdapter = new DevelopersListAdapter(developers);
        repositoriesList.setAdapter(developersListAdapter);
